...
All time up in percentage (including all unrealized gains and revenues received) is `r paste0(value, "%")` CAD. In absolute dollars, that is `r paste0(value2 + last(report.info$table.revenues$total.revenues))` CAD.
