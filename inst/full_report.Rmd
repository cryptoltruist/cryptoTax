...
value <- round(((format_dollars(report.summary$Amount[6], "numeric") + 
...
Your total "proceeds" *for the coins you sold at a **profit*** is: **\$`r format.dollars(proceeds$proceeds[1])`** (aggregated for all coins). Your total ACB *for the coins you sold at a profit* is: **\$`r format.dollars(proceeds$ACB.total[1])`** (average of all coins). The difference between the two is your capital gains: **\$`r format.dollars(proceeds$proceeds[1] - proceeds$ACB.total[1])`**.

Your total "proceeds" (adjusted for superficial gains) *for the coins you sold at a **loss*** is: **\$`r format.dollars(proceeds$proceeds[2])`** (aggregated for all coins). Your total ACB *for the coins you sold at a loss* is: **\$`r format.dollars(proceeds$ACB.total[2])`** (average of all coins). The difference between the two is your capital losses: **\$`r gsub("-", "", format.dollars(proceeds$proceeds[2] - proceeds$ACB.total[2]))`**.
