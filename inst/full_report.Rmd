...
> Those are only taxed at 50%. Your **capital losses** are calculated as **total capital losses** (**\$`r gsub("-", "", tot.sup.loss + sup.losses.total)`**) - **superficial losses** (**\$`r gsub("-", "", sup.losses.total)`**) = **actual capital losses** (**\$`r gsub("-", "", tot.sup.loss)`**).
