...
data_coinsmart <- structure(list(
  Credit = c(0, 0, 0.00004, 15, 0, 0, 198.5, 0, 250),
  Debit = c(0.3, 198.003, 0, 0, 0.197, 237.93743, 0, 2.25, 0), 
  TransactionType = c(
    "Fee", "Other", "Other", "Other", "Fee", "Trade", "Trade", "Fee", "Other"
  ), 
  ReferenceType = c(
    "Withdraw", "Withdraw", "Quiz", "Referral ", "Trade",
    "Trade", "Trade", "Deposit", "Deposit"
  ), 
  Product = c(
    "ADA", "ADA", "BTC", "CAD", "ADA", "CAD", "ADA", "CAD", "CAD"
  ), 
  Balance = c(
    0, 0.3,
    0.00004, 24.81254, 198.303, 9.81254, 198.5, 247.75, 250
  ), 
  TimeStamp = c(
    "2021/06/02 20:04:49.084", "2021/06/02 20:04:49.084",
