...
data_CDC <- structure(list(Timestamp..UTC. = c(
  ...
  0.35580671798495, 2.47619047619048, 37.1602562661344, 0.000532054153123365,
  0.00996365482758792
), To.Currency = c(
  "", "", "", "", "", "",
  "", "", "", "", "", "", "", "", "", "", "", "CAD", "CAD"
  ...
  1.25, 3.12, 0.26, 3.2, 1.20, 6.98, 35, 35
), Native.Amount..in.USD. = c(
  37.925,
  40.1154, 39.5308, 37, 25, 0.8362, 8.1326, 12.5356, 6.8006, 8.621,
  0.037, 0.925, 2.3088, 0.1924, 2.368, 0.888, 5.1652, 25.9, 25.9
), Transaction.Kind = c(
