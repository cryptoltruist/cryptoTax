...
test_that("Example #1", {
  ...
  data
  x <- format_suploss(data)

  expect_equal(
    ACB(x, spot.rate = "price"),
    structure(
      list(
  ...
  expect_equal(
    ...
    structure(
      list(
        ...
        suploss.range = new(
          "Interval", .Data = c(5184000, 5184000), 
  ...
  expect_equal(
    ...
    structure(
      list(
        ...
        price = c(3, 2, 3, 2, 2), 
        fees = c(0, 0, 0, 0, 0), 
        currency = c("XXX", "XXX", "XXX", "XXX", "XXX"), 
        total.quantity = c(150, 130, 180, 170, 90), 
        suploss.range = new(
          "Interval", .Data = c(5184000, 5184000, 5184000, 5184000, 5184000), 
          start = structure(c(
  ...
  expect_equal(
    ...
    structure(
      list(
        ...
        ACB.share = c(3, 3.15384615384615, 3.22222222222222, 
