...
- the package does **not** automatically decide whether wrapped tokens,
  bridged assets, liquid staking derivatives, exchange wrappers, or similar
  crypto variants should count as the same "identical property" for
  superficial-loss purposes
- the package does **not** decide whether your facts belong on income account
  instead of capital account

So the examples below are authoritative for the package's current transaction
math, but they are not a substitute for professional judgment in ambiguous
"identical property" cases.
